...
//void HttpServer::WaitForRequests(std::function<int (const HttpListenerRequest &, HttpListenerResponse &)> onConnection)
//{
//    while (true)
//    {
...
//            std::thread t(HttpListenerRequest::handleRequest, onConnection, HttpListenerRequest(socket, clientInfo));
//            t.detach();
//        }
//    }
//}
